      ...
      <Modal visible={valueModal == 1 ? true : false} transparent={true}>
        ...
        >
          ...
          >
            ...
            >
              <Text style={{ color: "white", fontSize: hp("5%") }}>Download</Text>
            </TouchableOpacity>
            ...
            elementoSelezionato.notPrivate == true ? (
              ...
              <TouchableOpacity
                ...
                style={{ marginTop: winSize.width > 900 ? "3%" : "7%" }}
              >
                <Text style={{ color: "white", fontSize: hp("5%") }}>
                  Copy link
                </Text>
              </TouchableOpacity>
            ) : null}
            ...
            >
              <Text style={{ color: "white", fontSize: hp("5%") }}>Rename</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={{ color: "white", fontSize: hp("5%") }}>Info</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={{ color: "red", fontSize: hp("5%") }}>Delete</Text>
            </TouchableOpacity>
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              style={{ marginTop: winSize.width > 900 ? "3%" : "7%" }}
            >
              <Text style={{ color: "white", fontSize: hp("5%") }}>Open</Text>
            </TouchableOpacity>
